...
Survey_Responses[!is.na(Survey_Responses$Race),] %>%
  ...
  coord_flip() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Race/Ethnicity", x = "Race/Ethnicity", y = "", fill = "Did you apply ED?")
```

```{r eval = FALSE}
ggplot(data = Survey_Responses[!is.na(Survey_Responses$Race),], mapping = aes(x = Race, fill = ED)) +
...
ggplot(data = Survey_Responses[!is.na(Survey_Responses$Race),], mapping = aes(x = ED, fill = Race)) +
  ...
  theme_minimal() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Race/Ethnicity", x = "Did you apply to Duke via the Early Decision process?", y = "", fill = "Race")
```
...
ggplot(data = Survey_Responses, mapping = aes(x = ED, fill = TrinityOrPratt)) +
  ...
  theme_minimal() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Trinity vs. Pratt", x = "Did you apply to Duke via the Early Decision process?", y = "", fill = "Are you in Trinity or Pratt?")
```
...
No significant difference shown between ED and RD groups.
...
ggplot(data = Survey_Responses, mapping = aes(x = ED, fill = Community)) +
  ...
  theme_minimal() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Home Community", x = "Did you apply to Duke via the Early Decision process?", y = "", fill = "What community are you from?")
```
```{r}
...
Survey_Responses[!is.na(Survey_Responses$FamilyAnnualIncome),] %>%
  ...
  coord_flip() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Estimated Family Annual Income", x = "Estimated Family Annual Income", y = "", fill = "Did you apply ED?")
```

```{r eval = FALSE}
ggplot(data = Survey_Responses[!is.na(Survey_Responses$FamilyAnnualIncome),], mapping = aes(x = FamilyAnnualIncome, fill = ED)) +
  geom_bar(position = "dodge", na.rm = T) + 
  scale_fill_brewer(palette ="Paired") +
  theme_minimal() +
  coord_flip() +
  labs(title = "Estimated Family Annual Income", x = "Estimated Family Annual Income", 
       fill = "Did you apply to Duke via ED?")
```
```{r}
...
ggplot(data = Survey_Responses[!is.na(Survey_Responses$FamilyAnnualIncome),], mapping = aes(x = ED, fill = FamilyAnnualIncome)) +
  ...
  theme_minimal() +
  scale_y_continuous(labels=scales::percent_format()) +
  labs(title = "Estimated Family Annual Income",
       x = "Did you apply to Duke via the Early Decision process?", 
       y = "", fill = "Estimated Family Annual Income")
```
```{r}
